...
print_error_message () {
    ...
    echo "  the expected output is found in file: $testdir/$testnum.$filetype"
    echo "  the result produced by your program is found in file: tests-out/$testnum.$filetype"
